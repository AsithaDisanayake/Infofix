 ...
 */
public class customercheque1 extends javax.swing.JFrame {

    /**
     * Creates new form supplier
     */
    public customercheque1() {
        initComponents();
//        atuono();
//        display();
        loadtb2();
...
//    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cheque No", "Customer ID", "Given Date", "Bank Deposit Date", "Amount"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (!jTextField1.getText().isEmpty() &&  !jTextField2.getText().isEmpty() && !jTextField6.getText().isEmpty()) {
                Connection com = DB.conect();
                PreparedStatement r = com.prepareStatement("insert into customercheque values('" + jTextField1.getText() + "','" + jTextField2.getText() + "','" + givendate + "','" + bankdate + "','" + jTextField6.getText() + "')");
                r.executeUpdate();
                r.close();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            Connection com = DB.conect();
            PreparedStatement r = com.prepareStatement("delete from customercheque where chequeno='" + jTextField1.getText() + "'");
            r.executeUpdate();
            r.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customercheque1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new customercheque1().setVisible(true);
            }
        });
    }
