...
public class supplier extends javax.swing.JFrame {
    ...
    void atuono() {
        try {
            ...
            ResultSet r = com.createStatement().executeQuery("select supid from supplier");
            int max = 1000;
            boolean b = false;
            while (r.next()) {
                b = true;
                int x = Integer.parseInt(r.getString("supid").trim());
                if (max < x) {
                    max = x;
                }
    ...
    private void jList1ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jList1ValueChanged
        try {
            ...
            ResultSet r = com.createStatement().executeQuery("select * from supplier where supid='" + a[0] + "'");
            while (r.next()) {
                String c = r.getString("supid");
    ...
    private void jTextField8KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField8KeyReleased
        try {
            Connection com = DB.conect();
            ResultSet r = com.createStatement().executeQuery("select * from supplier where supid='" + jTextField8.getText() + "'");
            boolean b = false;
            while (r.next()) {
                b = true;
                String a = r.getString("supid");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (!jTextField2.getText().isEmpty() && !jTextField3.getText().isEmpty() && !jTextField4.getText().isEmpty() && !jTextField5.getText().isEmpty() && !jTextField6.getText().isEmpty()) {
                Connection com = DB.conect();
                PreparedStatement r = com.prepareStatement("insert into supplier values('" + jTextField1.getText() + "','" + jTextField2.getText() + "','" + jTextField7.getText() + "','" + jTextField3.getText() + "','" + jComboBox1.getSelectedItem() + "','" + jTextField4.getText() + "','" + jTextField5.getText() + "','" + jTextField6.getText() + "')");
                r.executeUpdate();
                r.close();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            Connection com = DB.conect();
            PreparedStatement r = com.prepareStatement("delete from supplier where supid='" + jTextField1.getText() + "'");
            r.executeUpdate();
            r.close();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            Connection com = DB.conect();
            PreparedStatement r = com.prepareStatement("update supplier set fname='" + jTextField2.getText() + "',lname='" + jTextField7.getText() + "', mobile='" + jTextField3.getText() + "',gender='" + jComboBox1.getSelectedItem() + "',no='" + jTextField4.getText() + "',street='" + jTextField5.getText() + "',city='" + jTextField6.getText() + "'where supid='" + jTextField1.getText() + "'");
            r.executeUpdate();
            r.close();
